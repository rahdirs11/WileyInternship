...
-- Sir, I started off by importing the datasets and just altering the columns for Primary Key and Foreign Key.
-- After one of my batchmates asked the doubt regarding the same, you clarified that we have to create table from scratch.
-- I've added both, creation and alteration of the imported datasets
